...
calypsoCave={
    ...
    "description": """    Thoroughly disoriented, you arrive at a place that somewhat resembles your university's 
    reception, the only difference is that it's actually a cave, on an island, in Ancient Greece.
    A bottle hits your head and although you're somewhat disappointed that it's not wine, admist the shattered 
    ...
    'exits':{'east':'bluehole','down':'basement',"north" : 'sirenCorridor','south':'beach'}
}
...
circe={
    ...
    'exits':{'up':'treasury','north':'redhole','south':'sirenCorridor'},
...
cyclops = {
    ...
    An eyepatch clings to his skin, inset into his gaping cavernous eye socket and the room rumbles softly in a strange rumbling rhythm,
    ...
    he has some earplugs in his ears.''',

    'lowHelp' :  'Kleptomania might be bad but hey you need to get to your lecture.',
    'midHelp' :  '''I know it's kind of disgusting, but you got to do what you got to do.''',
    'highHelp' : '''That dinghy is made of strong stuff, it can go anywhere.''',
...
redhole = {'name':'redhole',
    ...
    'midHelp' :  '',
    'highHelp' : '',
    'exits':{'south':'circe','north':'ithaca'}
           }
...
bluehole = {'name':'bluehole',
    ...
    'midHelp' :  '',
    'highHelp' : '',
    'exits':{'east':'cyclopsEntrance','west':'calypsoCave'}
           }
